...
"""
    ...
    def validate_response(self, response):
        ...
        # try:
        #     url_list = ast.literal_eval(response.text)

        #     # Verify that each item is a valid URL
        #     if not isinstance(url_list, list):
        #         print("Response does not contain a list")
        #         return

        #     for url in url_list:
        #         if not isinstance(url, str):
        #             print(f"Invalid URL (not a string): {url}")
        #             continue
        #     return url_list
        # except (ValueError, SyntaxError) as e:
        #     print("Failed to parse response as list")
        #     print(e)
